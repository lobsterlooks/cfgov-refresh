...
trial_identifier="programmatic-trial-3"
reports_parent_page = CFGOVPage.objects.get(id=1113)
existing_report = BrowsePage.objects.get(id=13966)   # barf

def get_pandoc_output():
    report_file_location = "/Users/lortonel/dev/cfgov-project/pandoc/fourth-day-translating-elements/mini-report.docx"
...
#     cfgov/manage.py runscript create_report
def run():
    print(" *** running pandoc conversion... ***")
    new_content = get_pandoc_output()
